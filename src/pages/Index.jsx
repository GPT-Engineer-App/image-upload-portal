          ...
          <Box>
            {selectedFiles.map((file, index) => (
              <Box position="relative" key={index}>
                ...
                <Button position="absolute" right="calc(50% - 840px + 12px)" top="calc(50% - 350px + 12px)" size="xs" borderRadius="full" bg="black" _hover={{ bg: "blackAlpha.800" }} onClick={() => handleRemoveImage(index)} zIndex="10">
