    ...
    <Container maxW="container.lg" py={8}>
      <VStack spacing={8}>
        ...
        <Box position="relative" size="lg" height="100px" width="300px" padding="8px" border="1px solid" borderColor="gray.200" _placeholder={{ color: "gray.500" }}>
          ...
          <Box height="100px" width="300px" overflow="hidden" display="flex" flexWrap="wrap" justifyContent="flex-start" alignItems="center">
            {selectedFiles.map((file, index) => (
              <Image key={index} src={file} alt={`preview ${index}`} boxSize="65px" objectFit="cover" m="2px" />
            ))}
            <Text>{inputText}</Text>
          </Box>
        </Box>
